    ...
    return listCart.map((product) => {
      return (
        <tr key={product.maSP}>
          ...
          <td>
            <button disabled={product.soLuong === 1} onClick={() => {this.props.productQuantity(product, false)}}>-</button>{product.soLuong}<button onClick={() => {this.props.productQuantity(product, true)}}>+</button>
          </td>
